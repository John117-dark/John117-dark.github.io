...
<?php 
    ...
    $sql_ord="select * from ordenes order by orden_id DESC";
    $res_ord= $conexion->query($sql_ord) or die($conexion->error);
?>
    ...
    <div class="d-flex">
        ...
        <main class="flex-grow-1">
            ...
            <section class="p-4 container">
                ...
                <?php   
                    while($fila = mysqli_fetch_array($res_ord)){
                ?>

                    <div class="col-3 mt-2 p-2">
                        <div class="card">
                            <div class="card-body">
                              <h5 class="card-title"><?php echo $fila['estado']  ?></h5>
                              <p class="card-text">Usuario id= <?php echo $fila['usuario_id']  ?></p>
                              <p class="card-text">Fecha= <?php echo $fila['fecha']  ?></p>
                              <p class="card-text">Total= $<?php echo $fila['total']  ?></p>
